...
<html lang="en">
    <head>
        ...
        <link href="assets1/css/blocks.css" rel="stylesheet">
        <link href="assets1/css/date/bootstrap-datepicker.css" rel="stylesheet">
        <link href="assets1/css/date/bootstrap-datepicker3.css" rel="stylesheet">
        <!-- Special version of Bootstrap that only affects content wrapped in .bootstrap-iso -->
        <!-- <link rel="stylesheet" href="https://formden.com/static/cdn/bootstrap-iso.css" />  -->

        <!--Font Awesome (added because you use icons in your prepend/append)-->
        <link rel="stylesheet" href="https://formden.com/static/cdn/font-awesome/4.4.0/css/font-awesome.min.css" />
        <link href="assets1/css/material.css" rel="stylesheet">
    </head>
    <body>
        <!-- navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets1/img/logo.png" height="40px"></a>
                </div>
    ...
    <script src="assets1/js/date/bootstrap-datepicker.js"></script>
    <script src="assets1/js/moment.js"></script>
    <script src="assets1/js/transition.js"></script>
    <script src="assets1/js/collapse.js"></script>
