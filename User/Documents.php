...
<!--     {% for message in messages %}
  ...
  <div class="row" style="padding:1vw;">
    <div class="col-xl-12"> <i><u><strong>PERSONAL DOCUMENTS</strong></u></i><br>
      <div class="form-row">
      <div class="form-group col-md-6 mb-0">
        <label for="FName" class="col-xl-6 col-form-label"  style="color:#FFF700;">First Name:</label>
        <input type="text" readonly class="form-control-plaintext" id="FName" style="color: white" value=<?php echo $_SESSION['Fname'] ?>>
      </div>
      <div class="form-group col-md-6 mb-0">
        <label for="LName" class="col-xl-6 col-form-label" style="color:#FFF700;">Last Name:</label>
        <input type="text" readonly class="form-control-plaintext" id="LName" style="color: white" value=<?php echo $_SESSION['Lname'] ?>>
      </div>
      </div>
      <div class="form-row">
      <div class="form-group col-md-6 mb-0">
        <label for="gndr" class="col-xl-6 col-form-label"  style="color:#FFF700;">Gender:</label>
        <input type="text" readonly class="form-control-plaintext" id="gndr" style="color: white" value=<?php echo $_SESSION['Genders'] ?>>
      </div>
      <div class="form-group col-md-6 mb-0">
        <label for="usrnm" class="col-xl-6 col-form-label" style="color:#FFF700;">Username:</label>
        <input type="text" readonly class="form-control-plaintext" id="usrnm" style="color: white" value=<?php echo $_SESSION['Username1'] ?>>
      </div>
      </div>
      <div class="col-xl-12 col-form-label">
        <label for="Email" class="col-xl-6 col-form-label" style="color:#FFF700;">Email:</label>
        <input type="text" readonly class="form-control-plaintext" id="Email"  rows="25" style="color: white" value=<?php echo $_SESSION['Email'] ?>>
      </div>
    </div>
   </div>
